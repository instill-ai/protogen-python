...
Session = _reflection.GeneratedProtocolMessageType('Session', (_message.Message,), {
  'DESCRIPTOR' : _SESSION,
  '__module__' : 'usage.v1alpha.usage_pb2'
  # @@protoc_insertion_point(class_scope:usage.v1alpha.Session)
  })
...
SessionData = _reflection.GeneratedProtocolMessageType('SessionData', (_message.Message,), {
  ...
  '__module__' : 'usage.v1alpha.usage_pb2'
  # @@protoc_insertion_point(class_scope:usage.v1alpha.SessionData)
  })
...
MgmtUsageData = _reflection.GeneratedProtocolMessageType('MgmtUsageData', (_message.Message,), {
  ...
  '__module__' : 'usage.v1alpha.usage_pb2'
  # @@protoc_insertion_point(class_scope:usage.v1alpha.MgmtUsageData)
  })
...
ConnectorUsageData = _reflection.GeneratedProtocolMessageType('ConnectorUsageData', (_message.Message,), {
  ...
  'OwnerUsageData' : _reflection.GeneratedProtocolMessageType('OwnerUsageData', (_message.Message,), {
    ...
    '__module__' : 'usage.v1alpha.usage_pb2'
    # @@protoc_insertion_point(class_scope:usage.v1alpha.ConnectorUsageData.OwnerUsageData)
    })
  ,
  'DESCRIPTOR' : _CONNECTORUSAGEDATA,
  '__module__' : 'usage.v1alpha.usage_pb2'
  # @@protoc_insertion_point(class_scope:usage.v1alpha.ConnectorUsageData)
  })
...
ModelUsageData = _reflection.GeneratedProtocolMessageType('ModelUsageData', (_message.Message,), {
  ...
  'OwnerUsageData' : _reflection.GeneratedProtocolMessageType('OwnerUsageData', (_message.Message,), {
    ...
    '__module__' : 'usage.v1alpha.usage_pb2'
    # @@protoc_insertion_point(class_scope:usage.v1alpha.ModelUsageData.OwnerUsageData)
    })
  ,
  'DESCRIPTOR' : _MODELUSAGEDATA,
  '__module__' : 'usage.v1alpha.usage_pb2'
  # @@protoc_insertion_point(class_scope:usage.v1alpha.ModelUsageData)
  })
...
PipelineUsageData = _reflection.GeneratedProtocolMessageType('PipelineUsageData', (_message.Message,), {
  ...
  'OwnerUsageData' : _reflection.GeneratedProtocolMessageType('OwnerUsageData', (_message.Message,), {
    ...
    '__module__' : 'usage.v1alpha.usage_pb2'
    # @@protoc_insertion_point(class_scope:usage.v1alpha.PipelineUsageData.OwnerUsageData)
    })
  ,
  'DESCRIPTOR' : _PIPELINEUSAGEDATA,
  '__module__' : 'usage.v1alpha.usage_pb2'
  # @@protoc_insertion_point(class_scope:usage.v1alpha.PipelineUsageData)
  })
...
Report = _reflection.GeneratedProtocolMessageType('Report', (_message.Message,), {
  'DESCRIPTOR' : _REPORT,
  '__module__' : 'usage.v1alpha.usage_pb2'
  # @@protoc_insertion_point(class_scope:usage.v1alpha.Report)
  })
...
CreateSessionRequest = _reflection.GeneratedProtocolMessageType('CreateSessionRequest', (_message.Message,), {
  ...
  '__module__' : 'usage.v1alpha.usage_pb2'
  # @@protoc_insertion_point(class_scope:usage.v1alpha.CreateSessionRequest)
  })
...
CreateSessionResponse = _reflection.GeneratedProtocolMessageType('CreateSessionResponse', (_message.Message,), {
  ...
  '__module__' : 'usage.v1alpha.usage_pb2'
  # @@protoc_insertion_point(class_scope:usage.v1alpha.CreateSessionResponse)
  })
...
SendReportRequest = _reflection.GeneratedProtocolMessageType('SendReportRequest', (_message.Message,), {
  ...
  '__module__' : 'usage.v1alpha.usage_pb2'
  # @@protoc_insertion_point(class_scope:usage.v1alpha.SendReportRequest)
  })
...
SendReportResponse = _reflection.GeneratedProtocolMessageType('SendReportResponse', (_message.Message,), {
  ...
  '__module__' : 'usage.v1alpha.usage_pb2'
  # @@protoc_insertion_point(class_scope:usage.v1alpha.SendReportResponse)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\021com.usage.v1alphaB\nUsageProtoP\001Z<github.com/instill-ai/protogen-go/usage/v1alpha;usagev1alpha\242\002\003UXX\252\002\rUsage.V1alpha\312\002\rUsage\\V1alpha\342\002\031Usage\\V1alpha\\GPBMetadata\352\002\016Usage::V1alpha'
  ...
  _SESSION._serialized_start=163
  _SESSION._serialized_end=453
  _SESSIONDATA._serialized_start=456
  _SESSIONDATA._serialized_end=715
  _MGMTUSAGEDATA._serialized_start=717
  _MGMTUSAGEDATA._serialized_end=772
  _CONNECTORUSAGEDATA._serialized_start=775
  _CONNECTORUSAGEDATA._serialized_end=1214
  _CONNECTORUSAGEDATA_OWNERUSAGEDATA._serialized_start=868
  _CONNECTORUSAGEDATA_OWNERUSAGEDATA._serialized_end=1214
  _MODELUSAGEDATA._serialized_start=1217
  _MODELUSAGEDATA._serialized_end=1492
  _MODELUSAGEDATA_OWNERUSAGEDATA._serialized_start=1302
  _MODELUSAGEDATA_OWNERUSAGEDATA._serialized_end=1492
  _PIPELINEUSAGEDATA._serialized_start=1495
  _PIPELINEUSAGEDATA._serialized_end=1802
  _PIPELINEUSAGEDATA_OWNERUSAGEDATA._serialized_start=1586
  _PIPELINEUSAGEDATA_OWNERUSAGEDATA._serialized_end=1802
  _REPORT._serialized_start=1805
  _REPORT._serialized_end=2263
  _CREATESESSIONREQUEST._serialized_start=2265
  _CREATESESSIONREQUEST._serialized_end=2342
  _CREATESESSIONRESPONSE._serialized_start=2344
  _CREATESESSIONRESPONSE._serialized_end=2417
  _SENDREPORTREQUEST._serialized_start=2419
  _SENDREPORTREQUEST._serialized_end=2490
  _SENDREPORTRESPONSE._serialized_start=2492
  _SENDREPORTRESPONSE._serialized_end=2512
