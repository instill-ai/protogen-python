...
class Session(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["create_time", b"create_time", "report_time", b"report_time", "update_time", b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["arch", b"arch", "create_time", b"create_time", "edition", b"edition", "name", b"name", "os", b"os", "owner_uid", b"owner_uid", "report_time", b"report_time", "service", b"service", "token", b"token", "uid", b"uid", "update_time", b"update_time", "uptime", b"uptime", "version", b"version"]) -> None: ...
...
class MgmtUsageData(google.protobuf.message.Message):
    ...
    @property
    def user_usages(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[mgmt.v1beta.mgmt_pb2.AuthenticatedUser]:
        """Repeated user usage data"""

    @property
    def org_usages(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[mgmt.v1beta.mgmt_pb2.Organization]:
        """Repeated org usage data"""

    def __init__(
        self,
        *,
        user_usages: collections.abc.Iterable[mgmt.v1beta.mgmt_pb2.AuthenticatedUser] | None = ...,
        org_usages: collections.abc.Iterable[mgmt.v1beta.mgmt_pb2.Organization] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["org_usages", b"org_usages", "user_usages", b"user_usages"]) -> None: ...
...
class ConnectorUsageData(google.protobuf.message.Message):
    ...
    class UserUsageData(google.protobuf.message.Message):
        ...
        class ConnectorExecuteData(google.protobuf.message.Message):
            ...
            status: mgmt.v1beta.metric_pb2.Status.ValueType
            """Final status of the execution"""
            user_uid: builtins.str
            """UUID of the user who execute the connector"""
            user_type: mgmt.v1beta.mgmt_pb2.OwnerType.ValueType
            ...
            def ClearField(self, field_name: typing.Literal["connector_definition_uid", b"connector_definition_uid", "connector_uid", b"connector_uid", "execute_time", b"execute_time", "execute_uid", b"execute_uid", "status", b"status", "user_type", b"user_type", "user_uid", b"user_uid"]) -> None: ...
        ...
        owner_uid: builtins.str
        """Owner UUID"""
        owner_type: mgmt.v1beta.mgmt_pb2.OwnerType.ValueType
        """Owner type"""
        @property
        ...
        def ClearField(self, field_name: typing.Literal["connector_execute_data", b"connector_execute_data", "owner_type", b"owner_type", "owner_uid", b"owner_uid"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["usages", b"usages"]) -> None: ...
...
class ModelUsageData(google.protobuf.message.Message):
    ...
    class UserUsageData(google.protobuf.message.Message):
        ...
        class ModelTriggerData(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing.Literal["trigger_time", b"trigger_time"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["model_definition_uid", b"model_definition_uid", "model_task", b"model_task", "model_uid", b"model_uid", "status", b"status", "trigger_time", b"trigger_time", "trigger_uid", b"trigger_uid", "user_type", b"user_type", "user_uid", b"user_uid"]) -> None: ...
        ...
        def ClearField(self, field_name: typing.Literal["model_trigger_data", b"model_trigger_data", "owner_type", b"owner_type", "owner_uid", b"owner_uid"]) -> None: ...
...
class PipelineUsageData(google.protobuf.message.Message):
    ...
    class UserUsageData(google.protobuf.message.Message):
        ...
        class PipelineTriggerData(google.protobuf.message.Message):
            ...
            trigger_uid: builtins.str
            """UID for the trigger log"""
            trigger_mode: mgmt.v1beta.metric_pb2.Mode.ValueType
            """Trigger mode"""
            status: mgmt.v1beta.metric_pb2.Status.ValueType
            """Final status of the execution"""
        ...
        def ClearField(self, field_name: typing.Literal["owner_type", b"owner_type", "owner_uid", b"owner_uid", "pipeline_trigger_data", b"pipeline_trigger_data"]) -> None: ...
...
@typing.final
class ArtifactUsageData(google.protobuf.message.Message):
    ...
    class UserUsageData(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["owner_type", b"owner_type", "owner_uid", b"owner_uid"]) -> None: ...

    USAGES_FIELD_NUMBER: builtins.int
    @property
    def usages(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ArtifactUsageData.UserUsageData]:
        """Usage data of all users in the artifact service"""

    def __init__(
        self,
        *,
        usages: collections.abc.Iterable[global___ArtifactUsageData.UserUsageData] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["usages", b"usages"]) -> None: ...
...
class SessionReport(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["agent_usage_data", b"agent_usage_data", "artifact_usage_data", b"artifact_usage_data", "connector_usage_data", b"connector_usage_data", "mgmt_usage_data", b"mgmt_usage_data", "model_usage_data", b"model_usage_data", "pipeline_usage_data", b"pipeline_usage_data", "session", b"session", "usage_data", b"usage_data"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["agent_usage_data", b"agent_usage_data", "artifact_usage_data", b"artifact_usage_data", "connector_usage_data", b"connector_usage_data", "mgmt_usage_data", b"mgmt_usage_data", "model_usage_data", b"model_usage_data", "pipeline_usage_data", b"pipeline_usage_data", "pow", b"pow", "session", b"session", "session_uid", b"session_uid", "token", b"token", "usage_data", b"usage_data"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["usage_data", b"usage_data"]) -> typing.Literal["mgmt_usage_data", "connector_usage_data", "model_usage_data", "pipeline_usage_data", "artifact_usage_data", "agent_usage_data"] | None: ...
