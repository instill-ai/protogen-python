...
class _AppTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AppType.ValueType], builtins.type):
    ...
    APP_TYPE_AI_AGENT: _AppType.ValueType  # 2
...
"""AppType is a AI assistant app."""
APP_TYPE_AI_AGENT: AppType.ValueType  # 2
"""AppType is a AI agent app."""
...
class App(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ai_agent_app", b"ai_agent_app", "ai_assistant_app", b"ai_assistant_app", "create_time", b"create_time", "metadata", b"metadata", "update_time", b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ai_agent_app", b"ai_agent_app", "ai_assistant_app", b"ai_assistant_app", "app_id", b"app_id", "app_type", b"app_type", "app_uid", b"app_uid", "create_time", b"create_time", "creator_uid", b"creator_uid", "description", b"description", "metadata", b"metadata", "owner_uid", b"owner_uid", "tags", b"tags", "update_time", b"update_time"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["metadata", b"metadata"]) -> typing_extensions.Literal["ai_assistant_app", "ai_agent_app"] | None: ...
...
class CreateAppRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ai_agent_app", b"ai_agent_app", "ai_assistant_app", b"ai_assistant_app", "metadata", b"metadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ai_agent_app", b"ai_agent_app", "ai_assistant_app", b"ai_assistant_app", "app_type", b"app_type", "description", b"description", "id", b"id", "metadata", b"metadata", "namespace_id", b"namespace_id", "tags", b"tags"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["metadata", b"metadata"]) -> typing_extensions.Literal["ai_assistant_app", "ai_agent_app"] | None: ...
...
class ListAppsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["app_type", b"app_type", "namespace_id", b"namespace_id"]) -> None: ...
...
class UpdateAppRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ai_agent_app", b"ai_agent_app", "ai_assistant_app", b"ai_assistant_app", "metadata", b"metadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ai_agent_app", b"ai_agent_app", "ai_assistant_app", b"ai_assistant_app", "app_id", b"app_id", "last_ai_assistant_app_catalog_uid", b"last_ai_assistant_app_catalog_uid", "last_ai_assistant_app_top_k", b"last_ai_assistant_app_top_k", "metadata", b"metadata", "namespace_id", b"namespace_id", "new_app_id", b"new_app_id", "new_description", b"new_description", "new_tags", b"new_tags"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["metadata", b"metadata"]) -> typing_extensions.Literal["ai_assistant_app", "ai_agent_app"] | None: ...
