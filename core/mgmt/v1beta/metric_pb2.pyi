...
@typing_extensions.final
class ModelTriggerTableRecord(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["model_id", b"model_id", "model_uid", b"model_uid", "trigger_count_completed", b"trigger_count_completed", "trigger_count_errored", b"trigger_count_errored"]) -> None: ...

global___ModelTriggerTableRecord = ModelTriggerTableRecord

@typing_extensions.final
class ListModelTriggerTableRecordsRequest(google.protobuf.message.Message):
...
global___ListModelTriggerTableRecordsRequest = ListModelTriggerTableRecordsRequest

@typing_extensions.final
class ListModelTriggerTableRecordsResponse(google.protobuf.message.Message):
    """ListModelTriggerTableRecordsResponse contains the model metrics."""

    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    MODEL_TRIGGER_TABLE_RECORDS_FIELD_NUMBER: builtins.int
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    TOTAL_SIZE_FIELD_NUMBER: builtins.int
    @property
    def model_trigger_table_records(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ModelTriggerTableRecord]:
    ...
    def __init__(
        self,
        *,
        model_trigger_table_records: collections.abc.Iterable[global___ModelTriggerTableRecord] | None = ...,
        next_page_token: builtins.str = ...,
        total_size: builtins.int = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["model_trigger_table_records", b"model_trigger_table_records", "next_page_token", b"next_page_token", "total_size", b"total_size"]) -> None: ...

global___ListModelTriggerTableRecordsResponse = ListModelTriggerTableRecordsResponse
