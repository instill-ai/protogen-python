...
@typing_extensions.final
class InviteOrganizationMembersRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["emails", b"emails", "organization_id", b"organization_id"]) -> None: ...

global___InviteOrganizationMembersRequest = InviteOrganizationMembersRequest

@typing_extensions.final
class InviteOrganizationMembersResponse(google.protobuf.message.Message):
