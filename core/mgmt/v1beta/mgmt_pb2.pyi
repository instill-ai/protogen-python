...
class ApiToken(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_last_use_time", b"_last_use_time", "create_time", b"create_time", "expiration", b"expiration", "expire_time", b"expire_time", "last_use_time", b"last_use_time", "ttl", b"ttl", "update_time", b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_last_use_time", b"_last_use_time", "access_token", b"access_token", "create_time", b"create_time", "expiration", b"expiration", "expire_time", b"expire_time", "id", b"id", "last_use_time", b"last_use_time", "name", b"name", "state", b"state", "token_type", b"token_type", "ttl", b"ttl", "uid", b"uid", "update_time", b"update_time"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_last_use_time", b"_last_use_time"]) -> typing_extensions.Literal["last_use_time"] | None: ...
    @typing.overload
...
class OrganizationSubscription(google.protobuf.message.Message):
    ...
    class _PlanEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[OrganizationSubscription._Plan.ValueType], builtins.type):
        ...
        """Unspecified plan."""
        PLAN_UNPAID: OrganizationSubscription._Plan.ValueType  # 1
        """Unpaid."""
    ...
    """Unspecified plan."""
    PLAN_UNPAID: OrganizationSubscription.Plan.ValueType  # 1
    """Unpaid."""
