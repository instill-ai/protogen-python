...
class Connection(google.protobuf.message.Message):
    ...
    generated.
    """
    view: pipeline.pipeline.v1beta.common_pb2.View.ValueType
...
class GetNamespaceConnectionRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        namespace_id: builtins.str = ...,
        connection_id: builtins.str = ...,
        view: pipeline.pipeline.v1beta.common_pb2.View.ValueType | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_view", b"_view", "view", b"view"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_view", b"_view", "connection_id", b"connection_id", "namespace_id", b"namespace_id", "view", b"view"]) -> None: ...
...
class CreateNamespaceConnectionRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["connection", b"connection"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["connection", b"connection", "namespace_id", b"namespace_id"]) -> None: ...
...
class UpdateNamespaceConnectionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["connection", b"connection", "connection_id", b"connection_id", "namespace_id", b"namespace_id", "update_mask", b"update_mask"]) -> None: ...
...
class DeleteNamespaceConnectionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["connection_id", b"connection_id", "namespace_id", b"namespace_id"]) -> None: ...
...
class Integration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_help_link", b"_help_link", "_o_auth_config", b"_o_auth_config", "description", b"description", "help_link", b"help_link", "icon", b"icon", "id", b"id", "o_auth_config", b"o_auth_config", "setup_schema", b"setup_schema", "title", b"title", "uid", b"uid", "vendor", b"vendor", "view", b"view"]) -> None: ...
    @typing.overload
...
class LookUpConnectionAdminRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_view", b"_view", "view", b"view"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_view", b"_view", "uid", b"uid", "view", b"view"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_view", b"_view"]) -> typing.Literal["view"] | None: ...
