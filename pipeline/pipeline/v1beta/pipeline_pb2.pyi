...
class Pipeline(google.protobuf.message.Message):
    ...
    @property
    def sharing(self) -> pipeline.pipeline.v1beta.common_pb2.Sharing:
    ...
    @property
    def permission(self) -> pipeline.pipeline.v1beta.common_pb2.Permission:
    ...
    @property
    def data_specification(self) -> pipeline.pipeline.v1beta.component_definition_pb2.DataSpecification:
        """Data specifications."""
    ...
    def __init__(
        ...
        *,
        ...
        sharing: pipeline.pipeline.v1beta.common_pb2.Sharing | None = ...,
        metadata: google.protobuf.struct_pb2.Struct | None = ...,
        owner_name: builtins.str = ...,
        releases: collections.abc.Iterable[global___PipelineRelease] | None = ...,
        readme: builtins.str = ...,
        permission: pipeline.pipeline.v1beta.common_pb2.Permission | None = ...,
        visibility: global___Pipeline.Visibility.ValueType = ...,
        owner: core.mgmt.v1beta.mgmt_pb2.Owner | None = ...,
        creator_uid: builtins.str | None = ...,
        creator: core.mgmt.v1beta.mgmt_pb2.User | None = ...,
        owner_uid: builtins.str = ...,
        data_specification: pipeline.pipeline.v1beta.component_definition_pb2.DataSpecification | None = ...,
...
class PipelineRelease(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_description", b"_description", "alias", b"alias", "create_time", b"create_time", "data_specification", b"data_specification", "delete_time", b"delete_time", "description", b"description", "endpoints", b"endpoints", "id", b"id", "metadata", b"metadata", "name", b"name", "raw_recipe", b"raw_recipe", "readme", b"readme", "recipe", b"recipe", "uid", b"uid", "update_time", b"update_time"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_description", b"_description"]) -> typing.Literal["description"] | None: ...
...
class CreateNamespacePipelineRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["pipeline", b"pipeline"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["namespace_id", b"namespace_id", "pipeline", b"pipeline"]) -> None: ...
...
class GetNamespacePipelineRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_view", b"_view", "view", b"view"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_view", b"_view", "namespace_id", b"namespace_id", "pipeline_id", b"pipeline_id", "view", b"view"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_view", b"_view"]) -> typing.Literal["view"] | None: ...
...
class UpdateNamespacePipelineRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["namespace_id", b"namespace_id", "pipeline", b"pipeline", "pipeline_id", b"pipeline_id", "update_mask", b"update_mask"]) -> None: ...
...
class CreateNamespacePipelineReleaseRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["namespace_id", b"namespace_id", "pipeline_id", b"pipeline_id", "release", b"release"]) -> None: ...
...
class GetNamespacePipelineReleaseRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_view", b"_view", "view", b"view"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_view", b"_view", "namespace_id", b"namespace_id", "pipeline_id", b"pipeline_id", "release_id", b"release_id", "view", b"view"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_view", b"_view"]) -> typing.Literal["view"] | None: ...
...
class UpdateNamespacePipelineReleaseRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["namespace_id", b"namespace_id", "pipeline_id", b"pipeline_id", "release", b"release", "release_id", b"release_id", "update_mask", b"update_mask"]) -> None: ...
...
class DeleteNamespacePipelineReleaseRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["namespace_id", b"namespace_id", "pipeline_id", b"pipeline_id", "release_id", b"release_id"]) -> None: ...
...
class RenameUserPipelineReleaseRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "new_pipeline_release_id", b"new_pipeline_release_id"]) -> None: ...
