...
class PipelinePrivateServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListPipelinesAdmin = channel.unary_unary(
                ...
                request_serializer=pipeline_dot_v1beta_dot_pipeline__pb2.ListPipelinesAdminRequest.SerializeToString,
                response_deserializer=pipeline_dot_v1beta_dot_pipeline__pb2.ListPipelinesAdminResponse.FromString,
                _registered_method=True)
        self.LookUpPipelineAdmin = channel.unary_unary(
                '/pipeline.v1beta.PipelinePrivateService/LookUpPipelineAdmin',
                request_serializer=pipeline_dot_v1beta_dot_pipeline__pb2.LookUpPipelineAdminRequest.SerializeToString,
                response_deserializer=pipeline_dot_v1beta_dot_pipeline__pb2.LookUpPipelineAdminResponse.FromString,
                _registered_method=True)
...
def add_PipelinePrivateServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListPipelinesAdmin': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=pipeline_dot_v1beta_dot_pipeline__pb2.ListPipelinesAdminRequest.FromString,
                    response_serializer=pipeline_dot_v1beta_dot_pipeline__pb2.ListPipelinesAdminResponse.SerializeToString,
            ),
            'LookUpPipelineAdmin': grpc.unary_unary_rpc_method_handler(
                    servicer.LookUpPipelineAdmin,
                    request_deserializer=pipeline_dot_v1beta_dot_pipeline__pb2.LookUpPipelineAdminRequest.FromString,
                    response_serializer=pipeline_dot_v1beta_dot_pipeline__pb2.LookUpPipelineAdminResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'pipeline.v1beta.PipelinePrivateService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('pipeline.v1beta.PipelinePrivateService', rpc_method_handlers)
...
class PipelinePrivateService(object):
    ...
    def ListPipelinesAdmin(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/pipeline.v1beta.PipelinePrivateService/ListPipelinesAdmin',
            pipeline_dot_v1beta_dot_pipeline__pb2.ListPipelinesAdminRequest.SerializeToString,
            pipeline_dot_v1beta_dot_pipeline__pb2.ListPipelinesAdminResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def LookUpPipelineAdmin(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/pipeline.v1beta.PipelinePrivateService/LookUpPipelineAdmin',
            pipeline_dot_v1beta_dot_pipeline__pb2.LookUpPipelineAdminRequest.SerializeToString,
            pipeline_dot_v1beta_dot_pipeline__pb2.LookUpPipelineAdminResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
