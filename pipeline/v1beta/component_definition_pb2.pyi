...
class ComponentDefinition(google.protobuf.message.Message):
    ...
    """
    type: pipeline.v1beta.common_pb2.ComponentType.ValueType
    ...
    @property
    def tasks(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[pipeline.v1beta.common_pb2.ComponentTask]:
        """List of tasks that can be executed by the component."""

    @property
    def events(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[pipeline.v1beta.common_pb2.ComponentEvent]:
    ...
    def __init__(
        ...
        *,
        ...
        source_url: builtins.str = ...,
        version: builtins.str = ...,
        tasks: collections.abc.Iterable[pipeline.v1beta.common_pb2.ComponentTask] | None = ...,
        description: builtins.str = ...,
        release_stage: global___ComponentDefinition.ReleaseStage.ValueType = ...,
        events: collections.abc.Iterable[pipeline.v1beta.common_pb2.ComponentEvent] | None = ...,
    ) -> None: ...
