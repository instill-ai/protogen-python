...
class Sharing(google.protobuf.message.Message):
    ...
    class User(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["enabled", b"enabled", "role", b"role"]) -> None: ...
    ...
    class ShareCode(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["code", b"code", "enabled", b"enabled", "role", b"role", "user", b"user"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["share_code", b"share_code"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["share_code", b"share_code", "users", b"users"]) -> None: ...
...
class Permission(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["can_edit", b"can_edit", "can_release", b"can_release", "can_trigger", b"can_trigger"]) -> None: ...
...
class CheckNameResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["availability", b"availability"]) -> None: ...
...
class ComponentTask(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "name", b"name", "title", b"title"]) -> None: ...
