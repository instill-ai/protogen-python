...
class PipelineServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Liveness = channel.unary_unary(
                ...
                request_serializer=instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.LivenessRequest.SerializeToString,
                response_deserializer=instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.LivenessResponse.FromString,
                )
        self.Readiness = channel.unary_unary(
                '/instill.pipeline.v1alpha.PipelineService/Readiness',
                request_serializer=instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.ReadinessRequest.SerializeToString,
                response_deserializer=instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.ReadinessResponse.FromString,
                )
...
def add_PipelineServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Liveness': grpc.unary_unary_rpc_method_handler(
                    servicer.Liveness,
                    request_deserializer=instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.LivenessRequest.FromString,
                    response_serializer=instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.LivenessResponse.SerializeToString,
            ),
            'Readiness': grpc.unary_unary_rpc_method_handler(
                    servicer.Readiness,
                    request_deserializer=instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.ReadinessRequest.FromString,
                    response_serializer=instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.ReadinessResponse.SerializeToString,
            ),
...
class PipelineService(object):
    ...
    def Liveness(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/instill.pipeline.v1alpha.PipelineService/Liveness',
            instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.LivenessRequest.SerializeToString,
            instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.LivenessResponse.FromString,
    ...
    def Readiness(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/instill.pipeline.v1alpha.PipelineService/Readiness',
            instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.ReadinessRequest.SerializeToString,
            instill_dot_pipeline_dot_v1alpha_dot_pipeline__pb2.ReadinessResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
