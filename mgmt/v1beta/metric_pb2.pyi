...
class PipelineTriggerTableRecord(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["pipeline_id", b"pipeline_id", "pipeline_release_id", b"pipeline_release_id", "pipeline_release_uid", b"pipeline_release_uid", "pipeline_uid", b"pipeline_uid", "trigger_count_completed", b"trigger_count_completed", "trigger_count_errored", b"trigger_count_errored"]) -> None: ...
...
class ListPipelineTriggerTableRecordsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["next_page_token", b"next_page_token", "pipeline_trigger_table_records", b"pipeline_trigger_table_records", "total_size", b"total_size"]) -> None: ...

global___ListPipelineTriggerTableRecordsResponse = ListPipelineTriggerTableRecordsResponse

@typing.final
class ListPipelineTriggerChartRecordsV0Request(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_filter", b"_filter", "aggregation_window", b"aggregation_window", "filter", b"filter"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_filter", b"_filter"]) -> typing.Literal["filter"] | None: ...

global___ListPipelineTriggerChartRecordsV0Request = ListPipelineTriggerChartRecordsV0Request

@typing.final
class ListPipelineTriggerChartRecordsV0Response(google.protobuf.message.Message):
    ...
    PIPELINE_TRIGGER_CHART_RECORDS_FIELD_NUMBER: builtins.int
    @property
    def pipeline_trigger_chart_records(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PipelineTriggerChartRecordV0]:
        """A list of pipeline trigger records."""

    def __init__(
        self,
        *,
        pipeline_trigger_chart_records: collections.abc.Iterable[global___PipelineTriggerChartRecordV0] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["pipeline_trigger_chart_records", b"pipeline_trigger_chart_records"]) -> None: ...

global___ListPipelineTriggerChartRecordsV0Response = ListPipelineTriggerChartRecordsV0Response

@typing.final
class PipelineTriggerChartRecordV0(google.protobuf.message.Message):
...
class ListPipelineTriggerRecordsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["next_page_token", b"next_page_token", "pipeline_trigger_records", b"pipeline_trigger_records", "total_size", b"total_size"]) -> None: ...
