...
class ListTableBuilderAgentMessagesResponse(google.protobuf.message.Message):
    ...
    @property
    def messages(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[agent.agent.v1alpha.chat_pb2.Message]:
        """messages"""
    next_page_token: builtins.str
    """next page token"""
    total_size: builtins.int
    """total size"""
    @property
    def sender_profiles(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[agent.agent.v1alpha.chat_pb2.MessageSenderProfile]:
        """message sender profiles"""
    def __init__(
        self,
        *,
        messages: collections.abc.Iterable[agent.agent.v1alpha.chat_pb2.Message] | None = ...,
        next_page_token: builtins.str = ...,
        total_size: builtins.int = ...,
        sender_profiles: collections.abc.Iterable[agent.agent.v1alpha.chat_pb2.MessageSenderProfile] | None = ...,
    ) -> None: ...
...
class ChatWithTableBuilderAgentResponse(google.protobuf.message.Message):
    ...
    EVENT_FIELD_NUMBER: builtins.int
    @property
    def event(self) -> agent.agent.v1alpha.chat_pb2.ChatEvent:
        """The response from the table builder agent."""
    def __init__(
        self,
        *,
        event: agent.agent.v1alpha.chat_pb2.ChatEvent | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["event", b"event"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["event", b"event"]) -> None: ...
