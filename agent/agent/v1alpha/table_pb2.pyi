...
class _CellStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_CellStatus.ValueType], builtins.type):
    ...
    CELL_STATUS_DATA_NOT_FOUND: _CellStatus.ValueType  # 9
...
"""The cell's transparency generation encountered an error and failed to complete."""
CELL_STATUS_DATA_NOT_FOUND: CellStatus.ValueType  # 9
"""The cell's data cannot be found or generated by the agent."""
...
class Table(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        draft_mode: builtins.bool | None = ...,
        permission: global___Table.Permission | None = ...,
        catalog_id: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_draft_mode", b"_draft_mode", "agent_config", b"agent_config", "create_time", b"create_time", "draft_mode", b"draft_mode", "metadata", b"metadata", "permission", b"permission", "update_time", b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_draft_mode", b"_draft_mode", "agent_config", b"agent_config", "catalog_id", b"catalog_id", "create_time", b"create_time", "description", b"description", "draft_mode", b"draft_mode", "metadata", b"metadata", "permission", b"permission", "title", b"title", "uid", b"uid", "update_time", b"update_time"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_draft_mode", b"_draft_mode"]) -> typing_extensions.Literal["draft_mode"] | None: ...
...
@typing_extensions.final
class CreateTableFromTemplateResponse(google.protobuf.message.Message):
...
global___CreateTableFromTemplateResponse = CreateTableFromTemplateResponse
