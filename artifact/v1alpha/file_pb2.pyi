...
class _ConvertedFileTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ConvertedFileType.ValueType], builtins.type):
    ...
    CONVERTED_FILE_TYPE_THUMBNAIL: _ConvertedFileType.ValueType  # 7
...
"""video (standardized to MP4)"""
CONVERTED_FILE_TYPE_THUMBNAIL: ConvertedFileType.ValueType  # 7
"""thumbnail (1024px WebP preview generated by `GenerateThumbnailActivity`).
One row per original file, persisted alongside the other
`converted_file` rows. The corresponding MinIO object is exposed to
clients via `File.thumbnail_uri` as a stable
...
class ListFilesRequest(google.protobuf.message.Message):
    ...
    **Examples**:
    ...
    def ClearField(self, field_name: typing.Literal["_filter", b"_filter", "_page_size", b"_page_size", "_page_token", b"_page_token", "_view", b"_view", "filter", b"filter", "page_size", b"page_size", "page_token", b"page_token", "parent", b"parent", "view", b"view"]) -> None: ...
    @typing.overload
...
class GetFileRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_storage_provider", b"_storage_provider", "_view", b"_view", "name", b"name", "storage_provider", b"storage_provider", "view", b"view"]) -> None: ...
    @typing.overload
