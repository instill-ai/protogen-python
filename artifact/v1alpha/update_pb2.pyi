...
class RollbackAdminResponse(google.protobuf.message.Message):
    ...
    """Status message"""
    @property
    def knowledge_base(self) -> artifact.v1alpha.knowledge_base_pb2.KnowledgeBase:
        """The rolled-back knowledge base"""

    def __init__(
        self,
        *,
        knowledge_base: artifact.v1alpha.knowledge_base_pb2.KnowledgeBase | None = ...,
        message: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["knowledge_base", b"knowledge_base"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["knowledge_base", b"knowledge_base", "message", b"message"]) -> None: ...
...
class SetRollbackRetentionAdminRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["duration", b"duration", "name", b"name", "time_unit", b"time_unit"]) -> None: ...
...
class SetRollbackRetentionAdminResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["new_retention_until", b"new_retention_until", "previous_retention_until", b"previous_retention_until", "total_retention_seconds", b"total_retention_seconds"]) -> None: ...
...
class GetKnowledgeBaseUpdateStatusAdminResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["details", b"details", "message", b"message", "update_in_progress", b"update_in_progress"]) -> None: ...
...
class ExecuteKnowledgeBaseUpdateAdminResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["details", b"details", "message", b"message", "started", b"started"]) -> None: ...
...
class AbortKnowledgeBaseUpdateAdminResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["details", b"details", "message", b"message", "success", b"success"]) -> None: ...
