...
class Chunk(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["create_time", b"create_time", "id", b"id", "markdown_reference", b"markdown_reference", "name", b"name", "original_file_id", b"original_file_id", "reference", b"reference", "retrievable", b"retrievable", "tokens", b"tokens", "type", b"type", "uid", b"uid"]) -> None: ...
...
class ListChunksRequest(google.protobuf.message.Message):
    ...
    **Examples**:
    ...
    def ClearField(self, field_name: typing.Literal["_filter", b"_filter", "_page_size", b"_page_size", "_page_token", b"_page_token", "file_id", b"file_id", "filter", b"filter", "knowledge_base_id", b"knowledge_base_id", "namespace_id", b"namespace_id", "page_size", b"page_size", "page_token", b"page_token"]) -> None: ...
    @typing.overload
...
class GetChunkRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_chunk_type", b"_chunk_type", "chunk_id", b"chunk_id", "chunk_type", b"chunk_type", "file_id", b"file_id", "knowledge_base_id", b"knowledge_base_id", "namespace_id", b"namespace_id"]) -> None: ...
...
class UpdateChunkRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["chunk_id", b"chunk_id", "knowledge_base_id", b"knowledge_base_id", "namespace_id", b"namespace_id", "retrievable", b"retrievable"]) -> None: ...
...
class SearchChunksRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["file_ids", b"file_ids", "file_media_type", b"file_media_type", "knowledge_base_id", b"knowledge_base_id", "namespace_id", b"namespace_id", "tags", b"tags", "text_prompt", b"text_prompt", "top_k", b"top_k", "type", b"type"]) -> None: ...
