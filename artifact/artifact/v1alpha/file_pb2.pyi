...
class File(google.protobuf.message.Message):
    ...
    class Position(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["coordinates", b"coordinates", "unit", b"unit"]) -> None: ...
...
class CreateFileRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["file", b"file", "knowledge_base_id", b"knowledge_base_id", "namespace_id", b"namespace_id"]) -> None: ...
...
class DeleteFileRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["file_id", b"file_id", "knowledge_base_id", b"knowledge_base_id", "namespace_id", b"namespace_id"]) -> None: ...
...
class ListFilesRequest(google.protobuf.message.Message):
    ...
    **Examples**:
    ...
    def ClearField(self, field_name: typing.Literal["_filter", b"_filter", "_page_size", b"_page_size", "_page_token", b"_page_token", "filter", b"filter", "knowledge_base_id", b"knowledge_base_id", "namespace_id", b"namespace_id", "page_size", b"page_size", "page_token", b"page_token"]) -> None: ...
    @typing.overload
...
class ListFilesResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["files", b"files", "next_page_token", b"next_page_token", "page_size", b"page_size", "total_size", b"total_size"]) -> None: ...
...
class GetFileRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_storage_provider", b"_storage_provider", "_view", b"_view", "storage_provider", b"storage_provider", "view", b"view"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_storage_provider", b"_storage_provider", "_view", b"_view", "file_id", b"file_id", "knowledge_base_id", b"knowledge_base_id", "namespace_id", b"namespace_id", "storage_provider", b"storage_provider", "view", b"view"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_storage_provider", b"_storage_provider"]) -> typing.Literal["storage_provider"] | None: ...
    @typing.overload
...
class GetFileResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_derived_resource_uri", b"_derived_resource_uri", "derived_resource_uri", b"derived_resource_uri", "file", b"file"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_derived_resource_uri", b"_derived_resource_uri", "derived_resource_uri", b"derived_resource_uri", "file", b"file"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_derived_resource_uri", b"_derived_resource_uri"]) -> typing.Literal["derived_resource_uri"] | None: ...
...
class UpdateFileRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["file", b"file", "file_id", b"file_id", "knowledge_base_id", b"knowledge_base_id", "namespace_id", b"namespace_id", "update_mask", b"update_mask"]) -> None: ...
...
class ReprocessFileResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["file", b"file"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["file", b"file", "message", b"message"]) -> None: ...
