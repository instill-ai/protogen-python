...
class System(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_delete_time", b"_delete_time", "_description", b"_description", "config", b"config", "create_time", b"create_time", "delete_time", b"delete_time", "description", b"description", "id", b"id", "is_default", b"is_default", "name", b"name", "uid", b"uid", "update_time", b"update_time"]) -> None: ...
    @typing.overload
...
class RenameSystemAdminRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["new_system_id", b"new_system_id", "system_id", b"system_id"]) -> None: ...
