...
class Conversation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["catalog_id", b"catalog_id", "create_time", b"create_time", "id", b"id", "namespace_id", b"namespace_id", "uid", b"uid", "update_time", b"update_time"]) -> None: ...
...
class Message(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "update_time", b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["catalog_uid", b"catalog_uid", "content", b"content", "conversation_uid", b"conversation_uid", "create_time", b"create_time", "role", b"role", "type", b"type", "uid", b"uid", "update_time", b"update_time"]) -> None: ...
...
class CreateConversationRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["catalog_id", b"catalog_id", "conversation_id", b"conversation_id", "namespace_id", b"namespace_id"]) -> None: ...
...
class ListConversationsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["catalog_id", b"catalog_id", "namespace_id", b"namespace_id", "page_size", b"page_size", "page_token", b"page_token"]) -> None: ...
...
class CreateMessageRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["catalog_id", b"catalog_id", "content", b"content", "conversation_id", b"conversation_id", "namespace_id", b"namespace_id", "role", b"role", "type", b"type"]) -> None: ...
...
class ListMessagesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["catalog_id", b"catalog_id", "conversation_id", b"conversation_id", "include_system_messages", b"include_system_messages", "latest_k", b"latest_k", "namespace_id", b"namespace_id", "page_size", b"page_size", "page_token", b"page_token"]) -> None: ...
...
class UpdateMessageRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["catalog_id", b"catalog_id", "content", b"content", "conversation_id", b"conversation_id", "message_uid", b"message_uid", "namespace_id", b"namespace_id"]) -> None: ...
...
class DeleteMessageRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["catalog_id", b"catalog_id", "conversation_id", b"conversation_id", "message_uid", b"message_uid", "namespace_id", b"namespace_id"]) -> None: ...
