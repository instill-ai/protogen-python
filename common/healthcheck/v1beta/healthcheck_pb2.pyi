...
class HealthCheckRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_service", b"_service", "service", b"service"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_service", b"_service", "service", b"service"]) -> None: ...
