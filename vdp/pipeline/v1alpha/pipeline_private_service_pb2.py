...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n3vdp/pipeline/v1alpha/pipeline_private_service.proto\x12\x14vdp.pipeline.v1alpha\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a#vdp/pipeline/v1alpha/pipeline.proto2\x9a\x04\n\x16PipelinePrivateService\x12\x99\x01\n\x12ListPipelinesAdmin\x12/.vdp.pipeline.v1alpha.ListPipelinesAdminRequest\x1a\x30.vdp.pipeline.v1alpha.ListPipelinesAdminResponse\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/v1alpha/admin/pipelines\x12\xa3\x01\n\x10GetPipelineAdmin\x12-.vdp.pipeline.v1alpha.GetPipelineAdminRequest\x1a..vdp.pipeline.v1alpha.GetPipelineAdminResponse\"0\xda\x41\x04name\x82\xd3\xe4\x93\x02#\x12!/v1alpha/admin/{name=pipelines/*}\x12\xbd\x01\n\x13LookUpPipelineAdmin\x12\x30.vdp.pipeline.v1alpha.LookUpPipelineAdminRequest\x1a\x31.vdp.pipeline.v1alpha.LookUpPipelineAdminResponse\"A\xda\x41\tpermalink\x82\xd3\xe4\x93\x02/\x12-/v1alpha/admin/{permalink=pipelines/*}/lookUpB\xf1\x01\n\x18\x63om.vdp.pipeline.v1alphaB\x1bPipelinePrivateServiceProtoP\x01ZFgithub.com/instill-ai/protogen-go/vdp/pipeline/v1alpha;pipelinev1alpha\xa2\x02\x03VPX\xaa\x02\x14Vdp.Pipeline.V1alpha\xca\x02\x14Vdp\\Pipeline\\V1alpha\xe2\x02 Vdp\\Pipeline\\V1alpha\\GPBMetadata\xea\x02\x16Vdp::Pipeline::V1alphab\x06proto3')

_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, globals())
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'vdp.pipeline.v1alpha.pipeline_private_service_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PIPELINEPRIVATESERVICE.methods_by_name['GetPipelineAdmin']._options = None
  _PIPELINEPRIVATESERVICE.methods_by_name['GetPipelineAdmin']._serialized_options = b'\332A\004name\202\323\344\223\002#\022!/v1alpha/admin/{name=pipelines/*}'
  ...
  _PIPELINEPRIVATESERVICE._serialized_start=170
  _PIPELINEPRIVATESERVICE._serialized_end=708
