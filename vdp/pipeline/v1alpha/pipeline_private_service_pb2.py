...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PIPELINEPRIVATESERVICE.methods_by_name['LookUpConnectorDefinitionAdmin']._serialized_options = b'\332A\tpermalink\202\323\344\223\002;\0229/v1alpha/admin/{permalink=connector-definitions/*}/lookUp'
  _PIPELINEPRIVATESERVICE.methods_by_name['ListConnectorsAdmin']._options = None
  _PIPELINEPRIVATESERVICE.methods_by_name['ListConnectorsAdmin']._serialized_options = b'\202\323\344\223\002\033\022\031/v1alpha/admin/connectors'
  _PIPELINEPRIVATESERVICE.methods_by_name['LookUpConnectorAdmin']._options = None
  _PIPELINEPRIVATESERVICE.methods_by_name['LookUpConnectorAdmin']._serialized_options = b'\332A\tpermalink\202\323\344\223\0020\022./v1alpha/admin/{permalink=connectors/*}/lookUp'
  _PIPELINEPRIVATESERVICE.methods_by_name['CheckConnector']._options = None
  _PIPELINEPRIVATESERVICE.methods_by_name['CheckConnector']._serialized_options = b'\332A\tpermalink\202\323\344\223\002/\022-/v1alpha/admin/{permalink=connectors/*}/check'
  _globals['_PIPELINEPRIVATESERVICE']._serialized_start=305
  _globals['_PIPELINEPRIVATESERVICE']._serialized_end=1856
