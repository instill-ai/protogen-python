...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n-vdp/model/v1alpha/model_private_service.proto\x12\x11vdp.model.v1alpha\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1dvdp/model/v1alpha/model.proto2\xf4\x03\n\x13ModelPrivateService\x12\x87\x01\n\x0fListModelsAdmin\x12).vdp.model.v1alpha.ListModelsAdminRequest\x1a*.vdp.model.v1alpha.ListModelsAdminResponse\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/v1alpha/admin/models\x12\xab\x01\n\x10LookUpModelAdmin\x12*.vdp.model.v1alpha.LookUpModelAdminRequest\x1a+.vdp.model.v1alpha.LookUpModelAdminResponse\">\xda\x41\tpermalink\x82\xd3\xe4\x93\x02,\x12*/v1alpha/admin/{permalink=models/*}/lookUp\x12\xa4\x01\n\nCheckModel\x12$.vdp.model.v1alpha.CheckModelRequest\x1a%.vdp.model.v1alpha.CheckModelResponse\"I\xda\x41\x0fmodel_permalink\x82\xd3\xe4\x93\x02\x31\x12//v1alpha/admin/{model_permalink=models/*}/checkB\xd9\x01\n\x15\x63om.vdp.model.v1alphaB\x18ModelPrivateServiceProtoP\x01Z@github.com/instill-ai/protogen-go/vdp/model/v1alpha;modelv1alpha\xa2\x02\x03VMX\xaa\x02\x11Vdp.Model.V1alpha\xca\x02\x11Vdp\\Model\\V1alpha\xe2\x02\x1dVdp\\Model\\V1alpha\\GPBMetadata\xea\x02\x13Vdp::Model::V1alphab\x06proto3')
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MODELPRIVATESERVICE._serialized_end=655
