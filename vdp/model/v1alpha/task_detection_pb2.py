...
_DETECTIONINPUT = DESCRIPTOR.message_types_by_name['DetectionInput']
...
DetectionObject = _reflection.GeneratedProtocolMessageType('DetectionObject', (_message.Message,), {
  ...
  '__module__' : 'vdp.model.v1alpha.task_detection_pb2'
  # @@protoc_insertion_point(class_scope:vdp.model.v1alpha.DetectionObject)
  })
_sym_db.RegisterMessage(DetectionObject)

DetectionInput = _reflection.GeneratedProtocolMessageType('DetectionInput', (_message.Message,), {
  'DESCRIPTOR' : _DETECTIONINPUT,
  '__module__' : 'vdp.model.v1alpha.task_detection_pb2'
  # @@protoc_insertion_point(class_scope:vdp.model.v1alpha.DetectionInput)
  })
_sym_db.RegisterMessage(DetectionInput)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\025com.vdp.model.v1alphaB\022TaskDetectionProtoP\001Z@github.com/instill-ai/protogen-go/vdp/model/v1alpha;modelv1alpha\242\002\003VMX\252\002\021Vdp.Model.V1alpha\312\002\021Vdp\\Model\\V1alpha\342\002\035Vdp\\Model\\V1alpha\\GPBMetadata\352\002\023Vdp::Model::V1alpha'
