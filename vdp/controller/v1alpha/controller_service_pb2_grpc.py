...
class ControllerPrivateServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Liveness = channel.unary_unary(
                ...
                request_serializer=vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.LivenessRequest.SerializeToString,
                response_deserializer=vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.LivenessResponse.FromString,
                )
        self.Readiness = channel.unary_unary(
                '/vdp.controller.v1alpha.ControllerPrivateService/Readiness',
                request_serializer=vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.ReadinessRequest.SerializeToString,
                response_deserializer=vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.ReadinessResponse.FromString,
                )
...
def add_ControllerPrivateServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Liveness': grpc.unary_unary_rpc_method_handler(
                    servicer.Liveness,
                    request_deserializer=vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.LivenessRequest.FromString,
                    response_serializer=vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.LivenessResponse.SerializeToString,
            ),
            'Readiness': grpc.unary_unary_rpc_method_handler(
                    servicer.Readiness,
                    request_deserializer=vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.ReadinessRequest.FromString,
                    response_serializer=vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.ReadinessResponse.SerializeToString,
            ),
...
class ControllerPrivateService(object):
    ...
    def Liveness(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/vdp.controller.v1alpha.ControllerPrivateService/Liveness',
            vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.LivenessRequest.SerializeToString,
            vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.LivenessResponse.FromString,
    ...
    def Readiness(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/vdp.controller.v1alpha.ControllerPrivateService/Readiness',
            vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.ReadinessRequest.SerializeToString,
            vdp_dot_controller_dot_v1alpha_dot_healthcheck__pb2.ReadinessResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
