...
_CONNECTORUSAGEDATA_USERUSAGEDATA = _CONNECTORUSAGEDATA.nested_types_by_name['UserUsageData']
_MODELUSAGEDATA = DESCRIPTOR.message_types_by_name['ModelUsageData']
_MODELUSAGEDATA_USERUSAGEDATA = _MODELUSAGEDATA.nested_types_by_name['UserUsageData']
_PIPELINEUSAGEDATA = DESCRIPTOR.message_types_by_name['PipelineUsageData']
_PIPELINEUSAGEDATA_USERUSAGEDATA = _PIPELINEUSAGEDATA.nested_types_by_name['UserUsageData']
...
ConnectorUsageData = _reflection.GeneratedProtocolMessageType('ConnectorUsageData', (_message.Message,), {
  ...
  'UserUsageData' : _reflection.GeneratedProtocolMessageType('UserUsageData', (_message.Message,), {
    'DESCRIPTOR' : _CONNECTORUSAGEDATA_USERUSAGEDATA,
    '__module__' : 'vdp.usage.v1alpha.usage_pb2'
    # @@protoc_insertion_point(class_scope:vdp.usage.v1alpha.ConnectorUsageData.UserUsageData)
    })
  ,
...
_sym_db.RegisterMessage(ConnectorUsageData.UserUsageData)

ModelUsageData = _reflection.GeneratedProtocolMessageType('ModelUsageData', (_message.Message,), {

  'UserUsageData' : _reflection.GeneratedProtocolMessageType('UserUsageData', (_message.Message,), {
    'DESCRIPTOR' : _MODELUSAGEDATA_USERUSAGEDATA,
    '__module__' : 'vdp.usage.v1alpha.usage_pb2'
    # @@protoc_insertion_point(class_scope:vdp.usage.v1alpha.ModelUsageData.UserUsageData)
    })
  ,
...
_sym_db.RegisterMessage(ModelUsageData.UserUsageData)

PipelineUsageData = _reflection.GeneratedProtocolMessageType('PipelineUsageData', (_message.Message,), {

  'UserUsageData' : _reflection.GeneratedProtocolMessageType('UserUsageData', (_message.Message,), {
    'DESCRIPTOR' : _PIPELINEUSAGEDATA_USERUSAGEDATA,
    '__module__' : 'vdp.usage.v1alpha.usage_pb2'
    # @@protoc_insertion_point(class_scope:vdp.usage.v1alpha.PipelineUsageData.UserUsageData)
    })
  ,
...
_sym_db.RegisterMessage(PipelineUsageData.UserUsageData)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MODELUSAGEDATA_USERUSAGEDATA.fields_by_name['instance_online_state_num']._options = None
  _MODELUSAGEDATA_USERUSAGEDATA.fields_by_name['instance_online_state_num']._serialized_options = b'\340A\002'
  _MODELUSAGEDATA_USERUSAGEDATA.fields_by_name['instance_offline_state_num']._options = None
  ...
  _MODELUSAGEDATA._serialized_end=2153
  _MODELUSAGEDATA_USERUSAGEDATA._serialized_start=1705
  _MODELUSAGEDATA_USERUSAGEDATA._serialized_end=2153
  _PIPELINEUSAGEDATA._serialized_start=2156
  _PIPELINEUSAGEDATA._serialized_end=2589
  _PIPELINEUSAGEDATA_USERUSAGEDATA._serialized_start=2254
  _PIPELINEUSAGEDATA_USERUSAGEDATA._serialized_end=2589
  _SESSIONREPORT._serialized_start=2592
  _SESSIONREPORT._serialized_end=3102
  _CREATESESSIONREQUEST._serialized_start=3104
  _CREATESESSIONREQUEST._serialized_end=3185
  _CREATESESSIONRESPONSE._serialized_start=3187
  _CREATESESSIONRESPONSE._serialized_end=3264
  _SENDSESSIONREPORTREQUEST._serialized_start=3266
  _SENDSESSIONREPORTREQUEST._serialized_end=3355
  _SENDSESSIONREPORTRESPONSE._serialized_start=3357
  _SENDSESSIONREPORTRESPONSE._serialized_end=3384
