...
class UsageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Liveness = channel.unary_unary(
                '/vdp.usage.v1alpha.UsageService/Liveness',
                request_serializer=vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.LivenessRequest.SerializeToString,
                response_deserializer=vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.LivenessResponse.FromString,
                )
        self.Readiness = channel.unary_unary(
                '/vdp.usage.v1alpha.UsageService/Readiness',
                request_serializer=vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.ReadinessRequest.SerializeToString,
                response_deserializer=vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.ReadinessResponse.FromString,
                )
        self.CreateSession = channel.unary_unary(
                '/vdp.usage.v1alpha.UsageService/CreateSession',
...
def add_UsageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Liveness': grpc.unary_unary_rpc_method_handler(
                    servicer.Liveness,
                    request_deserializer=vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.LivenessRequest.FromString,
                    response_serializer=vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.LivenessResponse.SerializeToString,
            ),
            'Readiness': grpc.unary_unary_rpc_method_handler(
                    servicer.Readiness,
                    request_deserializer=vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.ReadinessRequest.FromString,
                    response_serializer=vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.ReadinessResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'vdp.usage.v1alpha.UsageService', rpc_method_handlers)
...
class UsageService(object):
    ...
    def Liveness(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/vdp.usage.v1alpha.UsageService/Liveness',
            vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.LivenessRequest.SerializeToString,
            vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.LivenessResponse.FromString,
    ...
    def Readiness(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/vdp.usage.v1alpha.UsageService/Readiness',
            vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.ReadinessRequest.SerializeToString,
            vdp_dot_usage_dot_v1alpha_dot_healthcheck__pb2.ReadinessResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CreateSession(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/vdp.usage.v1alpha.UsageService/CreateSession',
            vdp_dot_usage_dot_v1alpha_dot_usage__pb2.CreateSessionRequest.SerializeToString,
            vdp_dot_usage_dot_v1alpha_dot_usage__pb2.CreateSessionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
