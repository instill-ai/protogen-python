...
class ModelDefinition(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["create_time", b"create_time", "model_spec", b"model_spec", "update_time", b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["create_time", b"create_time", "documentation_url", b"documentation_url", "icon", b"icon", "id", b"id", "model_spec", b"model_spec", "name", b"name", "release_stage", b"release_stage", "title", b"title", "uid", b"uid", "update_time", b"update_time"]) -> None: ...
...
class ListModelDefinitionsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_page_size", b"_page_size", "_page_token", b"_page_token", "_view", b"_view", "page_size", b"page_size", "page_token", b"page_token", "view", b"view"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_page_size", b"_page_size", "_page_token", b"_page_token", "_view", b"_view", "page_size", b"page_size", "page_token", b"page_token", "view", b"view"]) -> None: ...
    @typing.overload
...
class ListModelDefinitionsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["model_definitions", b"model_definitions", "next_page_token", b"next_page_token", "total_size", b"total_size"]) -> None: ...
...
class GetModelDefinitionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_view", b"_view", "model_definition_id", b"model_definition_id", "view", b"view"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_view", b"_view"]) -> typing.Literal["view"] | None: ...
...
class GetModelDefinitionResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["model_definition", b"model_definition"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["model_definition", b"model_definition"]) -> None: ...
