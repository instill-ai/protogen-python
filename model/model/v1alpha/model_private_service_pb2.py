...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n/model/model/v1alpha/model_private_service.proto\x12\x13model.model.v1alpha\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1bgoogle/api/visibility.proto\x1a\x1fmodel/model/v1alpha/model.proto2\xdf\x05\n\x13ModelPrivateService\x12\x8b\x01\n\x0fListModelsAdmin\x12+.model.model.v1alpha.ListModelsAdminRequest\x1a,.model.model.v1alpha.ListModelsAdminResponse\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/v1alpha/admin/models\x12\xaf\x01\n\x10LookUpModelAdmin\x12,.model.model.v1alpha.LookUpModelAdminRequest\x1a-.model.model.v1alpha.LookUpModelAdminResponse\">\xda\x41\tpermalink\x82\xd3\xe4\x93\x02,\x12*/v1alpha/admin/{permalink=models/*}/lookUp\x12\xb5\x01\n\x10\x44\x65ployModelAdmin\x12,.model.model.v1alpha.DeployModelAdminRequest\x1a-.model.model.v1alpha.DeployModelAdminResponse\"D\x82\xd3\xe4\x93\x02>\"9/v1alpha/admin/{name=users/*/models/*}/{version=*}/deploy:\x01*\x12\xbd\x01\n\x12UndeployModelAdmin\x12..model.model.v1alpha.UndeployModelAdminRequest\x1a/.model.model.v1alpha.UndeployModelAdminResponse\"F\x82\xd3\xe4\x93\x02@\";/v1alpha/admin/{name=users/*/models/*}/{version=*}/undeploy:\x01*\x1a\x10\xfa\xd2\xe4\x93\x02\n\x12\x08INTERNALB\xe5\x01\n\x17\x63om.model.model.v1alphaB\x18ModelPrivateServiceProtoP\x01ZBgithub.com/instill-ai/protogen-go/model/model/v1alpha;modelv1alpha\xa2\x02\x03MMX\xaa\x02\x13Model.Model.V1alpha\xca\x02\x13Model\\Model\\V1alpha\xe2\x02\x1fModel\\Model\\V1alpha\\GPBMetadata\xea\x02\x15Model::Model::V1alphab\x06proto3')
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MODELPRIVATESERVICE.methods_by_name['DeployModelAdmin']._serialized_options = b'\202\323\344\223\002>\"9/v1alpha/admin/{name=users/*/models/*}/{version=*}/deploy:\001*'
  _MODELPRIVATESERVICE.methods_by_name['UndeployModelAdmin']._options = None
  _MODELPRIVATESERVICE.methods_by_name['UndeployModelAdmin']._serialized_options = b'\202\323\344\223\002@\";/v1alpha/admin/{name=users/*/models/*}/{version=*}/undeploy:\001*'
  _globals['_MODELPRIVATESERVICE']._serialized_start=190
  _globals['_MODELPRIVATESERVICE']._serialized_end=925
