...
class CallRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["task_inputs", b"task_inputs"]) -> None: ...
...
class CallResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["task_outputs", b"task_outputs"]) -> None: ...
